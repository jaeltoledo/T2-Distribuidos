...
func (s *Server) solicitudMonto(ctx context.Context, msg *pedirMonto) (*responderMonto, error) {
	peticion := int(msg.Body)
	fmt.Println("Mandando monto acumulado al lider: %i", pozo)
	return &responderMonto{Monto: pozo}
}
